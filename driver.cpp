...
{
    Graph graph; // declare graph object
    bool running = true;
    while (running)
    {
        cout << "======Main Menu======" << endl;
        cout << "1. Pre-made setup: Normal" << endl;
        cout << "2. Pre-made setup: traveling salesman" << endl;
        ...
        else if (stoi(input) == 12)
        {
            ...
            cout << "End Vertex Name:";
            string input2 = getInput();
            //outputPath(graph./*other algorithm*/(input, input2));
        }
